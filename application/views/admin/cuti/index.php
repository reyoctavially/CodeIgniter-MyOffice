	...
	<div class="row mt-3 mb-3">
		<div class="col-md-10">
			...
			<table class="table table-striped table-hover">
				<tr>
					<td colspan="6">
						<form  class="row g-2" method="POST" action="<?= base_url('cuti/cetak') ?>">
							<div class="col-12">
							...
							<div class="col-12">
								<button type="submit" name="cetak" class="btn btn-primary" style="width: 100%;">Cetak Data Cuti</button>
							</div>
						</form>
					</td>
				</tr>
				...
				<tbody>
					...
					foreach ($cuti as $ct) :
						...
						<tr>
							...
							<td class="text-center"><a class="btn btn-primary" href="<?= base_url(); ?>cuti/admin_detail/<?= $ct['kode_cuti']; ?>">Rincian</a></td>
						</tr>
						<?php
					endforeach;
					?>
